<template>
  <section class="relative py-16 md:py-24 px-5 overflow-hidden">
    <!-- Background glow -->
    <div class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[300px] rounded-full bg-ttc-primary opacity-[0.03] pointer-events-none" style="filter: blur(80px);" />
