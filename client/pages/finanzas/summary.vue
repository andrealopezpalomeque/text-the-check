...
async function createMonthlyTrendsChart() {
  ...
  try {
    ...
    try {
      ...
      useFinanzasToast("error", "Error al renderizar los gráficos");
    }
  }
}
...
async function updateCategoryPieChart() {
  ...
  try {
    ...
    try {
      ...
      console.error("Failed to recreate chart after error:", fallbackError);
      useFinanzasToast("error", "Error al renderizar el gráfico de categorías");
    }
  }
}
...
async function fetchData() {
  ...
  try {
    ...
    useFinanzasToast("error", "Error al cargar los datos del resumen");
  } finally {
